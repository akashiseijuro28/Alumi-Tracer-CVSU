...
//Q1
$q1sql="SELECT Q1, COUNT(Q1) as numq1 FROM survey WHERE Q1 IS NOT NULL GROUP BY Q1";
...
//Q2
$q2sql="SELECT Q2, COUNT(Q2) as numq2 FROM survey WHERE Q2 IS NOT NULL GROUP BY Q2";
...
//Q3
$q3sql="SELECT Q3, COUNT(Q3) as numq3 FROM survey WHERE Q3 IS NOT NULL GROUP BY Q3";
...
FROM jobinfo WHERE year(DateHired)>2002 group by  year(DateHired), Course, EmpStat order by year(DateHired)";
$sqltemp ="SELECT year(DateHired),
(SELECT COUNT(EmpStat)  WHERE   EmpStat = 'Employed') as TotalEmp
FROM jobinfo  WHERE  DateHired>2002 and EmpStat = 'Employed' group by  year(DateHired) order by year(DateHired)";
        ...
        <div class="content-box">
            <div class="content"> 
                <div class="head-page">
                    ...
                    <div style="margin: 5% 5% 0 5%;width:90%;height:100%;text-align:center; display:flexbox; border:2px solid green; box-shadow: 1px 1px 1px 1px rgb(0,0,0,.30); border-radius:1.5%">
                    ...
                    <div class="graphbox"style="margin: 5% 5% 0 5%;width:90%;height:100%; text-align:center; display:flexbox; border:2px solid green; box-shadow: 1px 1px 1px 1px rgb(0,0,0,.30);border-radius:1.5%">
