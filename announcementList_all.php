<?php
  ...
  require($serverdpphp);
    ...
    $sql_CountRecord = "SELECT COUNT(*) As totalRecords FROM announcement ";
    ...
    //$sql_announcementList = "SELECT * FROM announcement";
    $sql_announcementList = "SELECT * FROM announcement LIMIT $Offset, $recordsPerPage";
    $showAnnouncementList_query = mysqli_query($con, $sql_announcementList);

    //search in Announcement
    if(isset($_POST['searchAnnouncement'])){
        $SearchInAnnouncement = $_POST['SearchInAnnouncement'];
        header("Location: ../ADMIN_2.0/announcementList_all.php?PageNo=1&search={$SearchInAnnouncement}");   
    }
    if(isset($_GET['search'])){
        $bool = true;
        $SearchInAnnouncement = $_GET['search'];

        $sql_CountRecord = "SELECT COUNT(*) As totalRecords FROM announcement WHERE Subject LIKE '%".$SearchInAnnouncement."%' 
            OR EventDetails LIKE '%".$SearchInAnnouncement."%' 
            OR Author LIKE '%".$SearchInAnnouncement."%' 
            OR DateStart LIKE '%".$SearchInAnnouncement."%' 
            OR DatePosted LIKE '%".$SearchInAnnouncement."%' ";
        $CountRecord_query = mysqli_query($con, $sql_CountRecord);
        ...
        $SecLast = $recordsPerPage - 1;
            ...
            $sql_announcementList = "SELECT * FROM announcement WHERE Subject LIKE '%".$SearchInAnnouncement."%' 
            OR EventDetails LIKE '%".$SearchInAnnouncement."%' 
            OR Author LIKE '%".$SearchInAnnouncement."%' 
            OR DateStart LIKE '%".$SearchInAnnouncement."%' 
            OR DatePosted LIKE '%".$SearchInAnnouncement."%' 
                ...
                <div class="page">
                    ...
                    <div class="table-button">
                        <div class="drop-down">
                            <div class="select-dropdown">
                                <input type="text" placeholder="All" class="text-box" readonly>
                                <div class="option">
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <?php
                                while($row = mysqli_fetch_assoc($showAnnouncementList_query)){ 
                            ?>
                            <tr>
                        ...
                        <nav aria-label="Page navigation example">
                            ...
                            <li class="page-item" <?php if($PageNo <= 1){ echo "class='disabled'"; } ?> >
                                <a class="page-link" <?php if($PageNo > 1){
                                    if(isset($bool)){
                                        echo "href='announcementList_all.php?PageNo={$PrevPage}&search={$SearchInAnnouncement}'";
                                    }
                                    else{
                                        echo "href='announcementList_all.php?PageNo=$PrevPage'";
                                    }
                                } ?>>Previous</a>
                            </li>
                            ...
                            <li class="page-item" <?php if($PageNo >= $NoPages){
                                ...
                                <a class="page-link" <?php if($PageNo < $NoPages) {
                                    if(isset($bool)){
                                        echo "href='announcementList_all.php?PageNo={$NextPage}&search={$SearchInAnnouncement}'";
                                    }
                                    else{
                                        echo "href='announcementList_all.php?PageNo=$NextPage'";
                                    }
                                } ?>>Next</a>
                            </li>
                            ...
                            <?php if($PageNo > 1){
                                if(isset($bool) && $_GET['search'] != ''){
                                    echo "<li class='page-item'> <a class='page-link' href='announcementList_all.php?PageNo=1&search={$SearchInAnnouncement}'>First Page</a> </li>";
                                    }
                                    else{
                                        echo "<li class='page-item'> <a class='page-link' href='announcementList_all.php?PageNo=1'>First Page</a> </li>";
                                    }
                            } ?>
                            <?php if($PageNo < $NoPages){
                                if(isset($bool) && $_GET['search'] != ''){
                                    echo "<li class='page-item'> <a class='page-link' href='announcementList_all.php?PageNo=$NoPages&search={$SearchInAnnouncement}'>Last Page</a> </li>";
                                    }
                                    else{
                                        echo "<li class='page-item'> <a class='page-link' href='announcementList_all.php?PageNo=$NoPages'>Last Page</a> </li>";
                                    }
                            } ?>
                            </ul>
                        </nav> 
