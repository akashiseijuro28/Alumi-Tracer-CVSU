...
?>
   ...
   <div class="container-xxl container-p-y">
    <div class="misc-wrapper" style="align-items:center ;">
       <h2 class="mb-2 mx-2 text-center">Sorry no announcement yet</h2>
       <p class="mb-4 mx-2 text-center">Please wait for a while</p>
     </div>
   </div>
